...
public class RedmartChallenge1 {
	...
	public static HashMap<Point1, Integer> visitedPath=new HashMap<Point1, Integer>();
	public static List<Point1> longestPathStartingPoint=new ArrayList<Point1>();
	public static HashMap<String, Point1> allPoints=new HashMap<String, Point1>();
	public static int length=0;

	public static void init(){
		length=4;
		
		allPoints.put(0+" "+0,new Point1(0,0,4));
		allPoints.put(0+" "+1,new Point1(0,1,8));
		allPoints.put(0+" "+2,new Point1(0,2,7));
		allPoints.put(0+" "+3,new Point1(0,3,3));
		allPoints.put(1+" "+0,new Point1(1,0,2));
		allPoints.put(1+" "+1,new Point1(1,1,5));
		allPoints.put(1+" "+2,new Point1(1,2,9));
		allPoints.put(1+" "+3,new Point1(1,3,3));
		allPoints.put(2+" "+0,new Point1(2,0,6));
		allPoints.put(2+" "+1,new Point1(2,1,3));
		allPoints.put(2+" "+2,new Point1(2,2,2));
		allPoints.put(2+" "+3,new Point1(2,3,5));
		allPoints.put(3+" "+0,new Point1(3,0,4));
		allPoints.put(3+" "+1,new Point1(3,1,4));
		allPoints.put(3+" "+2,new Point1(3,2,1));
		allPoints.put(3+" "+3,new Point1(3,3,6));
	
	
			
	}
	
	public static void traverseNode(Point1 p){
	...
	public static Point1 getPoint(Point1 point){
	    ...
	    for (int j = 0; j < length; j++) {
	        ...
	        for (int i = 0; i < s.length; i++) {
	          //  data[j][i] = Integer.parseInt(s[i]);
	            allPoints.put(j+" "+i, new Point1(j,i,Integer.parseInt(s[i])));
	        }
	    }
	}
	...
	public static void findLongestPathStartingPoints(){
		int max=0;
		for(Point1 p:visitedPath.keySet()){
...
//	}
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		//find steepest
		Point1 steepest=null;
		int max=0;
		for(Point1 p:longestPathStartingPoint){
			int first=p.value();
			int end=p.value();
			Point1 firstPoint=p;
			while(p!=null){
